...
CREATE TABLE commands (id BIGINT AUTO_INCREMENT NOT NULL, argument VARCHAR(255), command VARCHAR(255) NOT NULL, executed DATETIME, requested DATETIME NOT NULL, status VARCHAR(255), machine BIGINT, PRIMARY KEY (id))
